...
# Since 1977
dict_cpi_series_code_1997 = {
    "CPI": "0000000000000000",
...
def get_cpi_df_year(dict_cpi_series_code = dict_cpi_series_code_1997, from_year = 1997, to_year = 2100):
    li = []
...
def get_cpi_df():
    df_1997 = get_cpi_df_year(dict_cpi_series_code = dict_cpi_series_code_1997, from_year = 1997, to_year = 2100)
    df_2003 = get_cpi_df_year(dict_cpi_series_code = dict_cpi_series_code_2003, from_year = 2003, to_year = 2100)
    df = pd.concat([df_1997, df_2003], axis = 1).reset_index()
    return df
...
if __name__ == '__main__':
    df = get_cpi_df()
    df.to_csv('.//Data//tha_cpi.csv', index = False)